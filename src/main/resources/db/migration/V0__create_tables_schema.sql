...
create table orders (created_at timestamp(6), customer_id uuid, id uuid not null default uuid_generate_v4(), city varchar(255), country varchar(255), county varchar(255), street_address varchar(255), primary key (id));
create table product (price float4 not null, weight float(53) not null, category_id uuid, id uuid not null default uuid_generate_v4(), description varchar(255), imageurl varchar(255), name varchar(255), primary key (id));
